...
public class Formulario extends javax.swing.JFrame {
    DefaultTableModel dt = new DefaultTableModel(); //crear objeto tabla: dt
    Proceso obj = new Proceso();
    
    public Formulario() {
        initComponents();
        tabla1.setModel(dt);
        dt.addColumn("Codigo Prod");
        dt.addColumn("Descripcion Prod");
        dt.addColumn("Saldo Prod");
    }
    ...
    private void BuscarXCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarXCodigoActionPerformed
        ...
        Integer idProd;
        idProd = Integer.parseInt(cod);
        dt.setRowCount(0);
        for(Producto p:obj.LisProducto(idProd)) {
            dt.addRow(new Object[] {p.getCodProd(), p.getDescrip(), p.getSaldo()});
        }
