...
public class Conexion {
    ...
    public Conexion() { // Constructor, carga puente JDBC-ODBC
        loadDriver();
    }
    
    private void loadDriver() { // Carga el driver de la conexion a la base de datos
        try {
    ...
    public Connection ObtenerConexion() { // Obtiene una conexion con el nombre del driver especificado
    ...
    public boolean closeConnection() {
        ...
        System.out.println("Conexino cerrada con exito ");
        return true;
    }
}
